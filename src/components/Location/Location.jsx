...
function Location() {
    ...
    const fetchData = async () => {
        try {
            const obj = {
                latitude: 21.165353392734936,
                longitude: 79.08082005145951
            }
    ...
    return (
        <div>
            <div className="d-flex text-center rounded-5" style={{ border: '1px solid black', background: "linear-gradient(to bottom, rgba(255, 255, 255, 0.9), rgba(0, 0, 0, 0))" }} onClick={handleLocation}>
